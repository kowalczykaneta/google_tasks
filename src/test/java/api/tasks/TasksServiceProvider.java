...
public class TasksServiceProvider {
     ...
     * Application name.
     */
    private static final String APPLICATION_NAME = "Aneta tasks test";

    /**
     * Directory to store user credentials for this application.
     */
    private static final java.io.File DATA_STORE_DIR = new java.io.File(
            System.getProperty("user.home"), ".credentials/aneta-tasks"
    );
    ...
    public static Credential authorize () throws IOException {
        // Load client secrets.
        InputStream in =
                TasksServiceProvider.class.getResourceAsStream("/client_secret.json");
